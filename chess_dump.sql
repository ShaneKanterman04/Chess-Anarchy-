...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '2ec9623f-b673-11f0-a7f6-42010a400002:1-287';
...
CREATE TABLE `gamematch` (
  ...
  `Ruleset_ID` varchar(100) DEFAULT NULL,
...
INSERT INTO `gamematch` VALUES (2,NULL,'Peter',NULL,'7'),(3,NULL,NULL,NULL,'C'),(4,NULL,NULL,NULL,'c'),(6,NULL,'shanekanterman22',NULL,'C'),(7,NULL,'user1',NULL,'C'),(8,NULL,NULL,NULL,'C'),(9,NULL,'shane1',NULL,'C'),(10,NULL,NULL,NULL,'C');
...
INSERT INTO `gamemode` VALUES ('C',NULL),('Z',NULL),('7',3);
...
INSERT INTO `match_spectators` VALUES (6,'null'),(10,'null');
...
CREATE TABLE `rules` (
  ...
  PRIMARY KEY (`Ruleset_ID`,`piece_type`),
...
INSERT INTO `rules` VALUES ('C','Bishop',0,0,7),('C','King',1,1,1),('C','Knight',2,1,0),('C','Pawn',0,1,0),('C','Queen',7,7,7),('C','Rook',7,7,0),('Z','Bishop',0,0,7),('Z','King',1,1,1),('Z','Knight',2,2,0),('Z','Pawn',1,1,0),('Z','Queen',7,7,7),('Z','Rook',7,7,0);
...
INSERT INTO `user` VALUES ('shane1','test',NULL,NULL,NULL),('shane2','test',NULL,NULL,NULL),('shaneadmin','test',NULL,NULL,NULL);
...
-- Dump completed on 2025-12-09 10:00:44
